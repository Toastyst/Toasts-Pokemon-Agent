...
states", and have the agent resume the same playthrough.
Everything lives on disk under:
...
new play goes through a GameSession so saves stay scoped to a single run.
"""
